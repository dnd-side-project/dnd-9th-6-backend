...
class LectureServiceTest {
    ...
    void getLectures4() {
        ...
        assertThat(response.getLectures().size()).isEqualTo(LECTURES.size());
    }

    @DisplayName("scope 메인 정보 및 후기, 강의를 조회한다.")
    @Test
    void getScopeLectures() {
        ...
        // then
        assertThat(response)
                .extracting("isLogin", "userName", "interests")
                .contains(false, "anonymous", "anonymous");
